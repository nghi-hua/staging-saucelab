...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_inventory_html/button_add_to_cart_sauce_labs_bolt_t_shirt'))

'Step 4: At Page inventory.html, click on hyperlink 2 > navigate to Page cart.html'
...
'Step 10: At Page checkout-step-one.html, click on input postalcode'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout-step-one_html/input_postalcode'))

'Step 11: At Page checkout-step-one.html, input on input postalcode'

WebUI.setText(findTestObject('AI-Generated/Page_checkout-step-one_html/input_postalcode'), input_postalcode)

'Step 12: At Page checkout-step-one.html, click on input continue > navigate to Page checkout-step-two.html'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout-step-one_html/input_continue'))

'Step 13: At Page checkout-step-two.html, click on button finish > navigate to Page checkout-complete.html'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout-step-two_html/button_finish'))

'Step 14: At Page checkout-complete.html, click on div object'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout-complete_html/div_object'))

'Step 15: At Page checkout-complete.html, click on button react burger menu btn'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_checkout-complete_html/button_react_burger_menu_btn'))

'Step 16: Add visual checkpoint at Page_checkout-complete.html'

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Checkout Process and Completion_visual_checkpoint')
